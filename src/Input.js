...
function Input({type, name, label, value, onChange}) {
    ...
    const inputExitCheck = (value, type) => {
        ...
        value === "" ? setInputEmpty("true") : setInputEmpty("false")
    }
    ...
    return (
        ...
        >
            ...
            <div 
                className={
                    inputEmpty === "true" ? 'raisely-invalid-input raisely-invalid' : 'raisely-invalid-input'
                }
            >
                <span className="raisely-invalid-input-text">
                    This field is required
                </span>
                {/* Your email address needs an at symbol (@) and at least one dot (.) */}
